...
<body>
<h1>Edit consumer:</h1>
<form:form id="consumerForm" method="POST" action="/consumers/edit">
    <table >
    <tr>
    <td>User id :</td>
    ...
    <tr>
    <td>Phone number : </td>
    <td><form:input id="phoneNumber" name="phoneNumber" path="phoneNumber" placeholder="Enter phoneNumber" /></td>phoneNumber
    </tr>
    <tr>
    <td>Email : </td>
