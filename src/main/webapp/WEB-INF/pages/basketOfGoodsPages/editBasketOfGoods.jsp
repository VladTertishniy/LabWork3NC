...
<form:form id="basketOfGoodsForm" method="POST" action="/basketOfGoods/edit">
    <table >
    <tr>
    <td>Goods id :</td>
    <td><form:hidden id="goodsId" name="goods.id" path="goods.id" placeholder="Enter goods id"/></td>
    </tr>
    <tr>
    <td>Order id : </td>
    <td><form:hidden id="orderId" name="order.id" path="order.id" placeholder="Enter order id"/></td>
    </tr>
    <tr>
    <td>Count : </td>
